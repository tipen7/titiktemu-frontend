...
function Input({ className, type, startIcon, endIcon, ...props }: InputProps) {
  ...
  return (
    <div className="relative w-full">
      {startIcon && (
        <span className="pointer-events-none absolute inset-y-0 left-4 flex items-center text-primary-600 sm:left-5">
          {startIcon}
        </span>
      )}
      {input}
